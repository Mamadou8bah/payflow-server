...
export function DashboardToolbar({
  ...
  return (
    <div className="mb-5 flex flex-col gap-3 rounded-[1.5rem] bg-white p-4 shadow-md sm:flex-row sm:flex-wrap sm:items-center">
      {onSearchChange ? (
      ...
      <div className="flex items-center gap-2 sm:ml-auto">
        ...
        {onRefresh ? (
          <button type="button" onClick={onRefresh} className="inline-flex h-11 items-center gap-2 rounded-full bg-slate-200 px-4 text-xs font-bold text-slate-800 hover:bg-slate-300">
        ...
        {onDownload ? (
          <button type="button" onClick={onDownload} className="inline-flex h-11 items-center gap-2 rounded-full bg-[#123c91] px-4 text-xs font-bold text-white hover:bg-[#0d2f76]">
